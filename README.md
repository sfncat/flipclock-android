...
- **自定义字体**：信息栏和天气可分别使用不同字体，内置 12 款开源中文字体可供选择（鸿蒙黑体、霞鹜漫黑、霞鹜新智宋、霞鹜文楷、霞鹜禧黑、霞鹜真楷、得意黑、思源宋体、文源黑体、小赖字体、悠哉字体、站酷快乐体）。信息栏默认使用霞鹜禧黑，天气默认使用霞鹜新智宋。
...
- 应用内置 12 款开源中文字体（位于 `assets/fonts/`，下拉列表在运行时由该目录实际文件动态生成，新增字体只需放入文件并在 `SettingsActivity.FONT_NAME_MAP` 补充显示名即可），信息栏和天气可分别使用不同字体，遵循 SIL Open Font License 1.1 开源协议。
